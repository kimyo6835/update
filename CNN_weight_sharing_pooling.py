...
unpool1 = tf.image.resize_images(pool3, [tf.shape(ho3)[1],tf.shape(ho3)[2]])
...
# Input Tensor Shape: [batch_size, 8, 8, 64]
# Output Tensor Shape: [batch_size, 16, 16, 64]
unpool2 = tf.image.resize_images(dho1, [tf.shape(ho2)[1],tf.shape(ho2)[2]])
...
# Input Tensor Shape: [batch_size, 16, 16, 32]
# Output Tensor Shape: [batch_size, 32, 32, 32]
unpool3 = tf.image.resize_images(dho2, [tf.shape(ho1)[1],tf.shape(ho1)[2]])
...
checkpoint_path = "./180426_CNN_pooling"
